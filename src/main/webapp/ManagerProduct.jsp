...
<body>
	...
	<div class="container-fluid bg-secondary mb-5">
		<div
			...
			<h1 class="font-weight-semi-bold text-uppercase mb-3">Manage
				Product</h1>
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="OrderManageController" class="btn btn-info"
							style="transform: translateX(150px);"><i
							class='bx bxs-wallet-alt'></i> Order manage</a> <a
							href="LoadAddController" class="btn btn-success"
							style="transform: translateX(150px);"><i
							class='bx bx-message-square-add'></i> Add New Product</a>
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><img src="<%=list.get(i).getImage()%>"></td>
						<td><%=list.get(i).getPrice()%> $</td>
						<td><a href="EditController?pid=<%=list.get(i).getId()%>"><i
								class="material-icons">&#xE254;</i></a> <a
							href="DeleteController?pid=<%=list.get(i).getId()%>"><i
