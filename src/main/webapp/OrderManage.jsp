		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="ManagerController" class="btn btn-info"
							style="transform: translateX(350px);"><i
							class='bx bxl-product-hunt'></i>Manage Product</a>
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><a
							href="OrderDetailManageController?id=<%=list.get(i).getId()%>">
								<i class="fa-solid fa-circle-info"></i> Detail</a></td>
					</tr>
					<%
					}
					%>
