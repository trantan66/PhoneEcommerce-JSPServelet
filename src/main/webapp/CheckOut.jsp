<%@page import="model.bean.Userinfo"%>
...
<body>
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="CheckOutController" class="dropdown-item active">Checkout</a>
                                </div>
                            </div>
                        </div>
	...
	<div class="container-fluid pt-5">
		<form action="AddToOrderDetail" method="post">
			<div class="row px-xl-5">
				<div class="col-lg-8">
				<% if(session.getAttribute("listuserinfo") != null){ 
						...
						<div class="row">
							...
							<div class="col-md-6 form-group">
								<label>First Name</label> <input class="form-control"
									type="text" name="firstname" value="<%= listuserinfo.get(i).getFirstname() %>"
									placeholder="Enter your first name" required="required">
							</div>
							<div class="col-md-6 form-group">
								<label>Last Name</label> <input class="form-control" type="text"
									placeholder="Enter your last name" name="lastname" value="<%= listuserinfo.get(i).getLastname() %>"
									required="required">
							</div>
							<div class="col-md-6 form-group">
								<label>E-mail</label> <input class="form-control" type="text"
									placeholder="Your E-mail@gmail.com" name="gmail" value="<%= listuserinfo.get(i).getGmail() %>"
									required="required">
							</div>
							<div class="col-md-6 form-group">
								<label>Mobile No</label> <input class="form-control" type="text"
									placeholder="+123 456 789" name="phonenumber" value="<%= listuserinfo.get(i).getPhonenumber() %>"
									required="required">
							</div>

							<div class="col-md-6 form-group">
								<label>Address</label> <input class="form-control" type="text"
									placeholder="Enter your address" name="address" value="<%= listuserinfo.get(i).getAddress() %>"
									required="required">
							</div>
							<div class="col-md-6 form-group">
							...
							<div class="col-md-6 form-group">
								<label>City</label> <input class="form-control" type="text" value="<%= listuserinfo.get(i).getCity() %>"
									placeholder="Enter your city" name="city" required="required"> 
							</div>
							<div class="col-md-6 form-group">
								<label>State</label> <input class="form-control" type="text" value="<%= listuserinfo.get(i).getState() %>"
					...
					<div class="mb-4">
						...
						<div class="row">
							...
							<div class="col-md-6 form-group">
								<label>E-mail</label> <input class="form-control" type="text"
									placeholder="Your E-mail@gmail.com" name="gmail"
									required="required">
							</div>
							<div class="col-md-6 form-group">
								<label>Mobile No</label> <input class="form-control" type="text"
									placeholder="+123 456 789" name="phonenumber"
									required="required">
							</div>
				...
				<div class="col-lg-4">
				<% if(session.getAttribute("checkout-list")!=null){%>
					<div class="card border-secondary mb-5">
						...
						<div class="card-body">
							...
							<%			
							List<Cart> list = (List<Cart>) session.getAttribute("checkout-list");
							Double total = 0.0;
							Double subtotal = 0.0;
							...
							<div class="d-flex justify-content-between">
								<input type="text" name="productid" value="<%= list.get(i).getId()%>" hidden="">
								<input type="text" name="quantity" value="<%= list.get(i).getQuantity()%>" hidden="">
								<input type="text" name="price" value="<%= list.get(i).getPrice() %>" hidden="">
							</div>
							<%
							}
							%>
					...
					<div class="card border-secondary mb-5">
						...
						<div class="card-body">
							<div class="form-group">
								<div class="custom-control custom-radio">
									<input type="radio" class="custom-control-input" name="payment"
										id="paypal" checked="checked" value="Paypal"> <label
							...
							<div class="form-group">
								<div class="custom-control custom-radio">
									<input type="radio" class="custom-control-input" name="payment"
										id="directcheck" value="Direct Check"> <label class="custom-control-label"
							...
							<div class="">
								<div class="custom-control custom-radio">
									<input type="radio" class="custom-control-input" name="payment"
										id="banktransfer" value="Bank Transfer"> <label class="custom-control-label"
