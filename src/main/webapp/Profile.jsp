...
<body>
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav ml-auto py-0">
							...
							<a href="EditProfileController" class="nav-item nav-link"><i
								class="fa-solid fa-address-card active"></i> Profile</a> <a
	...
	<div class="container-fluid pt-5">
		<%
		List<Userinfo> list = (List<Userinfo>) session.getAttribute("listuserinfo");
		%>
				...
				<div class="col-lg-4">
					<div class="card border-secondary mb-5">
						<div class="card-header bg-secondary border-0">
							<h4 class="font-weight-semi-bold m-0">Change password</h4>
						</div>
						<div class="card-body">
							...
							<div class="d-flex justify-content-between mb-3 pt-1">
								<h6 class="font-weight-medium">Old password</h6>
							</div>
							<div class="d-flex justify-content-between mb-3 pt-1">
								<input class="form-control" type="password" name="oldpassword">
							</div>
							<div class="d-flex justify-content-between mb-3 pt-1">
								<h6 class="font-weight-medium">New password</h6>
							</div>
							<div class="d-flex justify-content-between mb-3 pt-1">
							...
							<div class="d-flex justify-content-between mb-3 pt-1">
								<h6 class="font-weight-medium">Confirm new password</h6>
							</div>
							<div class="d-flex justify-content-between mb-3 pt-1">
								<input class="form-control" type="password"
							...
							<%
							String message1 = (String) session.getAttribute("wrong");
							String message2 = (String) session.getAttribute("wrongoldpassword");
							%>
							<%
							if (message1 != null) {
							%>
							...
							<%
							session.removeAttribute("wrongoldpassword");}
							%>
						</div>
					</div>
