...
public class AddController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			dao.addProduct(name, image, price, description, category);
			...
			dao.addProductDetail(productid, screen, system, frontcamera, rearcamera, chip, ram, capacity, sim, battery, company);
